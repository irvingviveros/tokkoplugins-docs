...
<Accordion>
  <AccordionItem title="API Key inválida o no funciona">
    ...
    **Soluciones:**
    1. Verifica que tu API Key sea correcta en **Tokko Plugins > Configuración > API**
    2. Asegúrate de copiar la clave completa sin espacios adicionales
    3. Verifica que la clave no haya sido revocada en tu cuenta Tokko Broker
    4. Intenta regenerar la API Key desde el panel Tokko Broker
    5. Limpia la caché del navegador y vuelve a intentar
  </AccordionItem>
...
<Accordion>
  <AccordionItem title="La sincronización no inicia">
    ...
    **Checklist de diagnóstico:**
    ...
    - [ ] ¿Es válida la API Key? Prueba la conexión en **Configuración > Herramientas**
    - [ ] ¿Está habilitado WP-Cron? Ejecuta `wp cron test` o verifica en **Tokko Plugins > Estado del Sistema**
    - [ ] ¿Hay permisos suficientes en tu cuenta Tokko Broker?
    - [ ] Desactiva plugins que conflictúen (cache, firewall, security)
    - [ ] Revisa los logs en **Tokko Plugins > Historial de Errores**
  </AccordionItem>
