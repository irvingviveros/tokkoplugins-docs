...
|---|---|---|
| Propiedades | 100 | Ilimitadas |
| Desarrollos (emprendimientos) | 2 | Ilimitados |
| Sincronización automática programada | ❌ (solo manual) | ✅ (frecuencia configurable) |
...
Para preguntas, reportes de errores o sugerencias sobre la API, contacta al equipo de Tokko Plugins en **support@tokkoplugins.com** o consulta la [documentación oficial](https://docs.tokkoplugins.com).
